...
def save_article(article):
    """שומר כתבה אחת לקובץ טקסט בתיקיית news."""
    ...
    # שמירה ל-data/news/<article_id>.txt
...
def main():
    print(f"🚀 מתחיל לאסוף כתבות עבור הנושא: {SECTION_NAME.upper()} (מסונן ל-articles בלבד)...")
    ...
    for page_num in range(1, total_pages + 1):
        params = {
            ...
            "page": page_num,
            "type": "article", # <--- **הוספנו את הסינון כאן**
        }
